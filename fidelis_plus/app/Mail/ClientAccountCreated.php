...
class ClientAccountCreated extends Mailable
{
    ...
    public function content(): Content
    {
        ...
        $badge = $this->isConversion ? 'Compte Client activé' : 'Bienvenue dans votre Espace Client';
        $intro = $this->isConversion
            ? 'Votre profil vient d\'être converti en compte Client. Votre espace personnel est prêt.'
            : 'Votre espace client a été créé avec succès. Voici vos accès personnels pour démarrer.';
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border-radius:28px; overflow:hidden; box-shadow:0 20px 50px rgba(15,25,35,0.12);">
                                    ...
                                    <td style="background-color:#0f2a24; background-image:linear-gradient(135deg,#1b1932 0%,#0f3d35 60%,#006b5d 100%); padding:36px 40px 30px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left:14px; vertical-align:middle;">
                                                    ...
                                                    <p style="margin:0; color:#8bf9a7; font-size:10.5px; font-weight:700; text-transform:uppercase; letter-spacing:0.14em;">Espace Client</p>
                                                </td>
                                            </tr>
                                        </table>
                                        <table role="presentation" cellpadding="0" cellspacing="0" style="margin-top:26px;">
                                            <tr><td style="background-color:rgba(255,255,255,0.12); border:1px solid rgba(255,255,255,0.25); border-radius:999px; padding:6px 14px;">
                                                <span style="color:#ffffff; font-size:11px; font-weight:700; letter-spacing:0.04em;">&#128663; ' . e($badge) . '</span>
                                            </td></tr>
                                        </table>
                                        ...
                                        <p style="margin:8px 0 0; color:#c9d8d4; font-size:14px; line-height:1.6; max-width:420px;">' . e($intro) . '</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:34px 40px 8px;">
                                            ...
                                            <tr><td align="center">
                                                <table role="presentation" cellpadding="0" cellspacing="0">
                                                    <tr><td style="background-color:#006b5d; background-image:linear-gradient(120deg,#006b5d,#15b9a3); border-radius:14px; box-shadow:0 10px 24px rgba(0,107,93,0.28);">
                                                        <a href="' . e($loginUrl) . '" style="display:inline-block; padding:16px 36px; color:#ffffff; font-size:12.5px; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; text-decoration:none;">Accéder à mon espace client &rarr;</a>
                                                    </td></tr>
                                                </table>
                                            </td></tr>
                                        </table>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:32px;">
                                            <tr>
                                                <td style="font-size:10px; font-weight:800; text-transform:uppercase; letter-spacing:0.14em; color:#006b5d; padding-bottom:14px;">Avec votre espace client</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:10px 0; border-top:1px solid #eef1ef;">
                                                    ...
                                                    <span style="font-size:13.5px; color:#3c4946; margin-left:10px; vertical-align:middle;">Gérez votre flotte de véhicules</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:10px 0; border-top:1px solid #eef1ef;">
                                                    ...
                                                    <span style="font-size:13.5px; color:#3c4946; margin-left:10px; vertical-align:middle;">Faites vos demandes de devis en quelques clics</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:10px 0 4px; border-top:1px solid #eef1ef;">
                                                    ...
                                                    <span style="font-size:13.5px; color:#3c4946; margin-left:10px; vertical-align:middle;">Suivez vos rendez-vous et interventions</span>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td style="padding:28px 40px 32px; background-color:#f4fbf8; border-top:1px solid #dde4e1;">
                                        <p style="margin:0 0 4px; color:#161d1b; font-size:12.5px; font-weight:700; text-align:center;">L\'équipe ' . e($appName) . '</p>
                                        <p style="margin:0; color:#8a9793; font-size:11px; text-align:center;">Cet email vous a été envoyé car un compte a été activé pour vous sur ' . e($appName) . '.</p>
                                    </td>
                                </tr>
